...
class PodRetrofit {
    ...
    fun getWeatherCme(apiKey: String, startDate: String, endDate: String): Call<ArrayList<DonkiCmeResponseData>>{
        return nasaApi.getDonkiCme(startDate, endDate, apiKey)
    }
